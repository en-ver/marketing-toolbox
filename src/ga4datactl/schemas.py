...
RUN_REPORT_BODY_SCHEMA: dict[str, Any] = _operation_schema(
    "RunReportRequest",
    schema_id=("urn:marketing-toolbox:ga4datactl:schema:run-report-body.schema.json"),
...
RUN_REALTIME_REPORT_BODY_SCHEMA: dict[str, Any] = {
    **CORE_REPORTING_DEFINITIONS,
    "$id": "urn:marketing-toolbox:ga4datactl:schema:run-realtime-report-body.schema.json",
...
CHECK_COMPATIBILITY_BODY_SCHEMA: dict[str, Any] = {
    **CORE_REPORTING_DEFINITIONS,
    "$id": "urn:marketing-toolbox:ga4datactl:schema:check-compatibility-body.schema.json",
...
CREATE_AUDIENCE_EXPORT_BODY_SCHEMA: dict[str, Any] = {
    ...
    "$id": "urn:marketing-toolbox:ga4datactl:schema:create-audience-export-body.schema.json",
